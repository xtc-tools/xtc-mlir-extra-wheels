...
This is a simple project wrapper for build MLIR extra tools used for the XTC project.

In particular:
- xtc-translate: a tool for MLIR to C code generation

The built packagea are vailable on PyPI as:
- xtc-mlir-extra-tools: binary tools;
- xtc-mlir-extra-dev: dev files, includes, archives and cmake recipes.

## Installing the MLIR extra wheels for some project
